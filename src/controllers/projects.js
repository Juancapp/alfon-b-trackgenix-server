...
//   if (!newProject.projectName || !newProject.projectStartDate || newProject.projectName === ''
...
//     fs.writeFile('src/data/projects.json', JSON.stringify(deleted, null, 2),
// (err) => (err ? res.status(400).json(
//       {
...
//     fs.writeFile('src/data/projects.json', JSON.stringify
// (deleted, null, 2), (err) => (err ? res.status(404).json(
//       {
//         msg: 'Cannot delete project',
//       },
//     ) : res.json(
